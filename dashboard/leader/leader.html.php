 ...
 <div class="panel-body text-center bk-padding-top-20 bk-wrapper bk-bg-white">
  ...
  <div class="panel-body bk-padding-off-bottom bk-padding-off-top bk-bg-info">
    ...
    <div class="row text-center">
      ...
      <button type="submit" name="action2" value="Leaving_History" class="btn btn-primary btn-lg hidden-xs col-lg-4 col-md-4 col-sm-4 col-xs-12 bk-bg-lighten bk-padding-top-10 bk-padding-bottom-10">
      <h4 class="bk-margin-off-bottom"> Leaving History </h4>
      <small>Leaving History </small>
      </button>
    </div>
    </form>
  </div>
